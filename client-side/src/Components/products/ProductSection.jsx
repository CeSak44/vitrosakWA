    ...
    <>
      ...
      >
        <motion.div 
          ...
          className="w-full h-full flex flex-col bg-[#113154]/40 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden shadow-2xl relative group"
        >
          {/* Image Slider at Top */}
              ...
              {[
                ...
                <div key={section.id} className="overflow-hidden">
                  <motion.button
                    ...
                    className={`w-full flex items-center justify-between py-4 px-5 rounded-2xl transition-all duration-300 ${
            ...
            {product.catalogueUrl && (
              ...
              >
                <a
                  href={encodeURI(product.catalogueUrl)}
                  download={product.catalogueUrl.split('/').pop()}
                  className="w-full flex items-center justify-center space-x-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold px-6 py-4 rounded-2xl shadow-xl active:scale-[0.98] transition-all duration-300"
                >
                  <Download className="w-5 h-5" />
